...
<?php $__env->startSection('content'); ?>
                ...
                <div class="col-lg-2 col-md-3 col-sm-3">
                    ...
                    <div>
                        <input type="text" class="form-control input-sm" name="banner_title"
                               <?php if(isset($search['advertise_title']) && $search['banner_title'] !=''): ?>value="<?php echo e($search['banner_title']); ?>"<?php endif; ?>>
                    </div>
                </div>
    ...
    <div class="row menu-option">
        ...
        <div class="col-lg-6 col-md-6 col-sm-6" style="text-align: right">
            <a href="<?php echo e(route('admin.banner_edit')); ?>"> <i class="fa fa-plus" title="thêm mới"></i> </a>
            <a href="javascript:void(0)"> <i class="fa fa-trash" id="deleteMoreItem" title="xóa item"></i> </a>
        </div>
    </div>
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12">
            <form action="<?php echo e(route('admin.banner_delete')); ?>" id="formListItem" name="formListItem" method="POST">
                        ...
                        <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k=>$item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td><input class="checkItem" name="checkItem[]" type="checkbox"
                                           value="<?php echo e($item->banner_id); ?>"></td>
                                <td><?php if($item->banner_media!=''): ?> <a href="javascript:void(0)" title="<?php echo e($item->banner_title); ?>" rel="<?php echo e(ThumbImg::thumbBaseNormal(\App\model\Banner::FOLDER,$item->banner_id,$item->banner_media,800,600,'',true,true,true)); ?>" id="showIMG"> <?php echo e($item->banner_title); ?> </a><?php else: ?> <?php echo e($item->banner_title); ?> <?php endif; ?></td>
                                <td><?php echo e($item->banner_link); ?></td>
                                <td><?php echo e(date('d/m/Y',$item->banner_created)); ?></td>
                                <td><?php if($item->banner_status == CGlobal::status_show): ?>
                                        <i class="fa fa-circle fa-admin green"></i>
                                    <?php else: ?>
                                        <i class="fa fa-circle fa-admin red"></i>
                                    <?php endif; ?>
                                </td>
                                <td><a href="<?php echo e(route('admin.banner_edit',['id'=>$item->banner_id])); ?>"><i
