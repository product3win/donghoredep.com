...
<section class="footer-2">
    <div class="container">
        ...
        <div class="col-md-3 col-sm-4">
            ...
            <ul>
                <?php $__currentLoopData = $hotroKH; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <li>
                        <a href="<?php echo e(route('hotrokhachhang',['name'=>$item->category_keyword])); ?>"
                           title="<?php echo e($item->category_title); ?>"><?php echo e($item->category_title); ?></a>
                    </li>
        ...
        <div class="col-md-3 col-sm-4">
            ...
            <ul>
                <?php $__currentLoopData = $chinhsachChung; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <li>
                        <a href="<?php echo e(route('hotrokhachhang',['name'=>$item->category_keyword])); ?>"
                           title="<?php echo e($item->category_title); ?>"><?php echo e($item->category_title); ?></a>
                    </li>
...
<section class="footer-3">
    <div class="container">
        <div class="col-md-4 col-sm-5 contact-left">
            Copyright © <?php echo e(date('Y',time())); ?> by Đồng Hồ Rẻ Đẹp
        </div>
