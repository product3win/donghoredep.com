...
<?php $__env->startSection('content'); ?>
                ...
                <div class="col-lg-2 col-md-3 col-sm-3">
                    ...
                    <div>
                        <input type="text" class="form-control input-sm" name="static_title"
                               <?php if(isset($search['static_title']) && $search['static_title'] !=''): ?>value="<?php echo e($search['static_title']); ?>"<?php endif; ?>>
                    </div>
                </div>
    ...
    <div class="row menu-option">
        <div class="col-lg-6 col-md-6 col-sm-6"><h5>Quản lý: Nội dung tĩnh [tổng số: <?php echo e($total); ?>]</h5></div>
        <div class="col-lg-6 col-md-6 col-sm-6" style="text-align: right">
            <a href="<?php echo e(route('admin.static_edit')); ?>"> <i class="fa fa-plus" title="thêm mới"></i> </a>
            <a href="javascript:void(0)"> <i class="fa fa-trash" id="deleteMoreItem" title="xóa item"></i> </a>
        </div>
    </div>
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12">
            <form action="<?php echo e(route('admin.static_delete')); ?>" id="formListItem" name="formListItem" method="POST">
                        ...
                        <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k=>$item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td><input class="checkItem" name="checkItem[]" type="checkbox"
                                           value="<?php echo e($item->static_id); ?>"></td>
                                <td><?php echo e($item->static_title); ?></td>
                                <td><?php echo e($item->static_keyword); ?></td>
                                <td><?php if($item->static_status == CGlobal::status_show): ?>
                                        <i class="fa fa-circle fa-admin green"></i>
                                    <?php else: ?>
                                        <i class="fa fa-circle fa-admin red"></i>
                                    <?php endif; ?>
                                </td>
                                <td><a href="<?php echo e(route('admin.static_edit',['id'=>$item->static_id])); ?>"><i
