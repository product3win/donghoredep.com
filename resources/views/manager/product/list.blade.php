                    ...
                    <div class="checkbox">
                        <label>
                            <input type="checkbox" name="product_gif" value="1"
                                   @if(isset($search['product_gif'])&&$search['product_gif']==1) checked @endif />
                            Quà tặng
                        </label>
                    </div>
                </div>
                    ...
                    <table class="table table-bordered table-hover">
                        ...
                        @foreach($data as $k=>$item)
                            <tr>
                                ...
                                <td>@if($item->product_media!='') <a href="javascript:void(0)" title="{{$item->product_title}}" rel="{{ThumbImg::thumbBaseNormal(\App\model\Product::FOLDER,$item->product_id,$item->product_media,800,600,'',true,true,true)}}" id="showIMG"> {{$item->product_title}} </a>@else {{$item->product_title}} @endif</td>
                                <td>
