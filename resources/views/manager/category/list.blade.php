                    ...
                    <table class="table table-bordered table-hover">
                        ...
                        @foreach($data as $k=>$item)
                            <tr>
                                ...
                                <td>@if($item->category_media!='') <a href="javascript:void(0)" title="{{$item->category_title}}" rel="{{ThumbImg::thumbBaseNormal(\App\model\Category::FOLDER,$item->category_id,$item->category_media,800,600,'',true,true,true)}}" id="showIMG"> {{$item->category_title}} </a>@else {{$item->category_title}} @endif</td>
                                <td>
